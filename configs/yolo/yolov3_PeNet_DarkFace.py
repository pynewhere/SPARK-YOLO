_base_ = ['../_base_/default_runtime.py', '../_base_/datasets/darkface_yolo.py']
...
# optimizer
optimizer = dict(type='SGD', lr=0.001, momentum=0.9, weight_decay=0.0005) # 1e-3
...
lr_config = dict(
    policy='step',
    warmup='linear',
    warmup_iters=5000,  # same as burn-in in darknet
    warmup_ratio=0.1,
    # step=[12, 16])
    step=[12])
# runtime settings
